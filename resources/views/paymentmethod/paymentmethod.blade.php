...
@section('content')
	...
	<nav class="navbar navbar-light">
		...
		<a class="btn btn-danger btn-sm" href="{{ url('paymentmethod/new') }}">+</a>
	</nav>
	...
	<table class="table">
		...
		<tr>
			...
			<td>
				...
				|
				<a class="btn btn-danger btn-sm" href="{{url('paymentmethod/delete/'.$pm->id)}}" onclick="return confirm('Are you sure?')">Delete</a>
			</td>
		</tr>
		@endforeach
	</table>
