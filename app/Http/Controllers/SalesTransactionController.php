...
class SalesTransactionController extends Controller
{
    ...
    public function new()
    {
        ...
        if ( session ('sales_outlet_id') == null )
        {
    ...
    public function add(Request $request)
    {
        ...
        $salestransaction->sales_outlet_id = session ('sales_outlet_id');
        ...
        return view('salestransaction/makepaymentmethod',['salestransaction' => $salestransaction, 'paymentmethod' => $paymentmethod]);
    }

    public function addPaymentMethod(Request $request)
    {
        $salestransaction = SalesTransaction::where('id', [$request->salestransaction])->getModel();
        $paymentmethod = PaymentMethod::where('id', [$request->payment_method])->get();
        $salestransaction->paymentMethod()->attach($paymentmethod,['sales_transaction_id'=>$request->salestransaction, 'payment_amount'=>$request->payment_amount, 'card_number'=>$request->card_number]);
    ...
    public function search(Request $request)
	{
		...
		$salestransaction = SalesTransaction::where('id','like',"%".$search."%")
		->paginate();
